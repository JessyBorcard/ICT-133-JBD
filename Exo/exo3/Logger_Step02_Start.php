...
$testValues = array(
    ...
    "2" => array(2, "This is a warning"),
    "3" => array(3, "This is an error"),
    "4" => array(24, "this is unknown"),
    "5" => array(1, "Too short"),
...
function prepareMsgToWrite($msg, $levelNumber)
{
    ...
    $instant_message = date("Y-n-t G-i-s")."\t".convertLevelIntToDescription($levelNumber)."\t".$msg;
